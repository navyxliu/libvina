...
%and help tailor programs to specific mulSticore architectures.
...
%It is still unclear that template metaprogramming is
%sufficient to perform source transformations for those
%cases. 

%%General applications
%%also contain a variety of static information. 
