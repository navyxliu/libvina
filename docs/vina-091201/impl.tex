...
%problem, each function object or cloure object is decorated with a loop-variable counter.
...
for heterogenous muliticores. For instance, we use OpenCL's \code{NDRangeKernel} function
