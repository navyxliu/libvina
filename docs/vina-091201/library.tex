...
Inside function \code{inner}, line 24-26 define size-reduced classes after dividing the task. 
...
Finally, line 47-48 computes all sub-matrices in parallel, where \code{par\_helper2}
...
Line 1-16 define a full specialization of \code{TF\_pipeline}, which is the end
